...
var initParticles = function() {
    ...
    var createParticlesShader = function() {
        ...
        var fragment = [
            ...
            "   float vx = 0.0+cos(0.5+2.0*(pos.x));",
            "   float vy = cos(4.0*(pos.y+0.5)) + sin(4.0*pos.x);",
            "   float vz = cos(pos.z*2.0);",
            ...
            "   return texture2D( DistanceMap, vec2(pos.x, pos.z)).b;",
            "}",
            "vec3 getDirection(vec3 pos) {",
            "   vec2 grad = texture2D( DistanceMap, vec2(pos.x, pos.z)).rg;",
            "   vec3 dir = vec3(grad[0]-0.5, 0.5-pos.y, grad[1]-0.5);",
            "   dir = normalize(dir);",
            "   return dir;",
            "}",
            ...
            "   targetVec += getVelocityField(currentPosition) * 0.2;",
            "   targetVec = getDirection(currentPosition)*0.4;",
            "   ",
